...
Float Property fScalingMaxMultiplier Auto
...
Function ResolveLeveledDamage()
	...
	If fScalingMaxMultiplier != 0
        Float fBonusDamage = ( Game.GetPlayer().GetAv("Pickpocket") / 100 ) * fScalingMaxMultiplier * damage
        damage += fBonusDamage as Int
    EndIf
